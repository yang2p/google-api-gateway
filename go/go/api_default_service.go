...
func (s *DefaultApiService) PatchUsersUserId(ctx context.Context, userId int32, body PatchUsersUserIdRequest) (ImplResponse, error) {
...
func (s *DefaultApiService) PostUser(ctx context.Context, body PostUserRequest) (ImplResponse, error) {
