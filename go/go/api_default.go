...
func (c *DefaultApiController) PatchUsersUserId(w http.ResponseWriter, r *http.Request) {
	...
	bodyParam := PatchUsersUserIdRequest{}
	...
	if err := AssertPatchUsersUserIdRequestRequired(bodyParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.PatchUsersUserId(r.Context(), userIdParam, bodyParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
...
func (c *DefaultApiController) PostUser(w http.ResponseWriter, r *http.Request) {
	...
	if err := AssertPostUserRequestRequired(bodyParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	result, err := c.service.PostUser(r.Context(), bodyParam)
	// If an error occurred, encode the error with the status code
	if err != nil {
		c.errorHandler(w, r, err, &result)
		return
